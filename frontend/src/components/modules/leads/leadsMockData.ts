import type { CRMModuleConfig, CRMRowAction, FilterSection, LeadRecord } from "../../../lib/shared/crmTypes";

export const leadFilterSections: FilterSection[] = [
  {
  ...
  },
  {
    ...
    items: ["Contacts", "Accounts", "Deals", "Cases", "Calls", "Meetings", "Tasks", "Emails"],
  },
];
